...
DIR=/media/sonata/MyBook/sec_corpus/$year
CORPUS=$DIR/$ye'_corpus_new.txt'
echo $CORPUS
VOCAB_FILE=$DIR/new_vocab_$year.txt
COOCCURRENCE_FILE=$DIR/new_cooccurrence_$year.bin
COOCCURRENCE_SHUF_FILE=$DIR/new_cooccurrence_$year.shuf.bin
BUILDDIR=build
#SAVE_FILE=../../embedding/Twitter_Glove/twitter_vectors_$year
SAVE_FILE=/media/sonata/MyBook/sec_embedding/new_sec_vectors_$year
VERBOSE=2
MEMORY=40.0
VOCAB_MIN_COUNT=$2
VECTOR_SIZE=300
