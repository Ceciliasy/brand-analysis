...
DIR=/mnt/HDD/$year
CORPUS=$DIR/tweets_new.$year.txt
VOCAB_FILE=$DIR/vocab_new_$year.txt
COOCCURRENCE_FILE=$DIR/cooccurrence_new_$year.bin
COOCCURRENCE_SHUF_FILE=$DIR/cooccurrence_new_$year.shuf.bin
BUILDDIR=build
#SAVE_FILE=../../embedding/Twitter_Glove/twitter_vectors_$year
SAVE_FILE=/mnt/HDD/embedding/twitter_vectors_new_$year
VERBOSE=2
MEMORY=30.0
VOCAB_MIN_COUNT=$2
